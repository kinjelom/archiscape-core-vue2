...
export default class Landscape extends Vue {
  ...
  public retrieveAllLandscapes(): void {
  ...
  public prepareRemove(instance: ILandscape): void {
  ...
  public removeLandscape(): void {
    this.landscapeService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('archiscapeCoreApp.landscape.deleted', { param: this.removeId });
