...
export default class ProjectElement extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProjectElements();
  }
  ...
  public retrieveAllProjectElements(): void {
  ...
  public prepareRemove(instance: IProjectElement): void {
  ...
  public removeProjectElement(): void {
    this.projectElementService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('archiscapeCoreApp.projectElement.deleted', { param: this.removeId });
