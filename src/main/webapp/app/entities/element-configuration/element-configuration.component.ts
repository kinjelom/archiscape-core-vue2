...
export default class ElementConfiguration extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllElementConfigurations();
  }
  ...
  public retrieveAllElementConfigurations(): void {
  ...
  public prepareRemove(instance: IElementConfiguration): void {
  ...
  public removeElementConfiguration(): void {
    this.elementConfigurationService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('archiscapeCoreApp.elementConfiguration.deleted', { param: this.removeId });
